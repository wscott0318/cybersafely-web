...
export function DashboardIntroText() {
  return (
    <Stack spacing={0.5}>
      ...
      <Typography>
        As a member of CyberSafely.ai, you'll have access to advanced security features and tools that will protect you
        from online threats, such as phishing scams, malware, and identity theft. Our platform uses the latest AI
        technology to analyze and detect potential risks, so you can browse the web with peace of mind.
      </Typography>
      <Typography>
        In addition to our security features, we're committed to providing a user-friendly experience that's tailored to
        your needs. Whether you're a tech-savvy individual or new to the digital world, our platform is designed to be
